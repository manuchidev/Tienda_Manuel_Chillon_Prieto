			          ...
			          <div class="card bg-dark text-white" style="border-radius: 1rem;">
			            ...
			            <div class="card-body p-4 text-center">
			            	...
			            	<div class="mb-0">
				              ...
				              <h2 class="text-uppercase text-center mb-5">ALTA DE EMPLEADO</h2>
				
				              <form novalidate action="EmpleadoAdmin" method="post" id="formRegistro" class="form-container" onsubmit="return validarRegistro(event)">
