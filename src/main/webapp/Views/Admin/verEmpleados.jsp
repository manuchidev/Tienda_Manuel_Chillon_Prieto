...
<html>
	...
	<body class="gradient-custom">
		...
		<main>
			...
			<% List<UsuarioVO> empleados = (List<UsuarioVO>) request.getAttribute("empleados"); %>	
			...
			<div class="container-fluid px-2 px-lg-5 mt-4">
				...
				<h2 class="text-center mb-4" style="color: white">EMPLEADOS</h2>
			...
			<%			for (UsuarioVO usuario: empleados) { %>
									...
									<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
										...
										<div class="text-center">
											...
											<form action="EmpleadoAdmin" method="get">
												...
												<input type="hidden" name="idEmpleado" value="<%= usuario.getId()%>">
