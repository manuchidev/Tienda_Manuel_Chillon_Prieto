...
<html>
	...
	<body>
		...
		<main>
			...
			<% 
				UsuarioVO usuario = (UsuarioVO) request.getAttribute("empleadoModif");			
			%>
		
			<section class="gradient-custom py-4">
			
				<h2 class="text-center mb-4" style="color: white">ACTUALIZACIÓN DE EMPLEADO</h2>
						...
						<div class="col-md-5 divCentral">
							...
							<div class="p-3 py-3">
								...
								<div class="d-flex justify-content-center align-items-center mb-3">
									<h4 class="text-center text-white">Datos del Empleado</h4>
								</div>
								
								<form action="EmpleadoAdmin" method="post">
