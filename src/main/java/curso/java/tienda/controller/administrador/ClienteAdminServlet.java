...
/**
 * Servlet implementation class ClienteAdminServlet
 */

@WebServlet("/ClienteAdmin")
public class ClienteAdminServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClienteAdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch (accion) {
			...
			case "add":
				request.getRequestDispatcher(Rutas.ALTA_CLIENTE_ADMIN_JSP).forward(request, response);
				break;
