...
<%-- 								<td><img src="${pageContext.request.contextPath}${Rutas.IMAGENES_PROD}${producto.imagen}" height="50" width="50"></td> --%>
<!-- 								<td> -->
<%-- 									<a href="ProductoEmpleado?accion=edit&id=${producto.id}">Editar</a> --%>
<!-- 								</td> -->
<!-- 							</tr> -->
<%-- 						</c:forEach> --%>
